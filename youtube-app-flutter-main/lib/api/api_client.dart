...
class ApiClient extends GetxService {
  ...
  Future<Response> getDataOther(String uri,
      {Map<String, dynamic>? query, Map<String, String>? headers}) async {
    try {
      if (Foundation.kDebugMode) {
        print('====> API Call: $uri\nHeader: $_mainHeaders');
  ...
  Future<Response> facePost(String uri, dynamic body,
      {Map<String, String>? headers}) async {
    try {
      if (Foundation.kDebugMode) {
        print('====> API Call: $uri\nHeader: $_mainHeaders');
  ...
  Future<Response> faceVerifyPostData(
      String uri, Map<String, String> body, List<MultipartBody> multipartBody,
      {Map<String, String>? headers}) async {
    try {
      if (Foundation.kDebugMode) {
      ...
      Http.MultipartRequest _request = Http.MultipartRequest(
          'POST', Uri.parse("https://test.peaksender.com/" + uri));
      _request.headers.addAll(headers ?? _mainHeaders!);
